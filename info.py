ek# Don't Remove Credit @VJ_Botz
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL','-1002222465571'). LOG_CHANNEL))
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://gplinks.co/GO0nJTs4')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", t"{script.CAPTION}")
